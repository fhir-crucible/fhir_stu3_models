...
class AndOrNotTest < Test::Unit::TestCase
  def test_and_or_not
    ...
    result = FluentPath::STU3.evaluate('deceased.not() and ((name.given or name.family) and gender) and deceased.not()', data)
  ...
  def test_xor_tt
    ...
    result = FluentPath::STU3.evaluate('a xor b', data)
