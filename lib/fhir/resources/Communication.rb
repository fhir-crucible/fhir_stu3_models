module FHIR
  class Communication < FHIR::Model
    ...
    METADATA = {
      ...
      'subject' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Patient'], 'type'=>'Reference', 'path'=>'Communication.subject', 'min'=>0, 'max'=>1},
      'requestDetail' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/CommunicationRequest'], 'type'=>'Reference', 'path'=>'Communication.requestDetail', 'min'=>0, 'max'=>1}
    }
    ...
    attr_accessor :requestDetail     # 0-1 Reference(CommunicationRequest)
