module FHIR
  class DeviceUseRequest < FHIR::Model
    ...
    METADATA = {
      ...
      'bodySiteReference' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/BodySite'], 'type'=>'Reference', 'path'=>'DeviceUseRequest.bodySite[x]', 'min'=>0, 'max'=>1},
      ...
      'device' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Device'], 'type'=>'Reference', 'path'=>'DeviceUseRequest.device', 'min'=>1, 'max'=>1},
      'encounter' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Encounter'], 'type'=>'Reference', 'path'=>'DeviceUseRequest.encounter', 'min'=>0, 'max'=>1},
      ...
      'subject' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Patient'], 'type'=>'Reference', 'path'=>'DeviceUseRequest.subject', 'min'=>1, 'max'=>1},
    ...
    attr_accessor :bodySiteReference       # 0-1 Reference(BodySite)
