module FHIR
  class SupplyDelivery < FHIR::Model
    ...
    METADATA = {
      ...
      'suppliedItem' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Medication', 'http://hl7.org/fhir/StructureDefinition/Substance', 'http://hl7.org/fhir/StructureDefinition/Device'], 'type'=>'Reference', 'path'=>'SupplyDelivery.suppliedItem', 'min'=>0, 'max'=>1},
    ...
    attr_accessor :suppliedItem      # 0-1 Reference(Medication|Substance|Device)
