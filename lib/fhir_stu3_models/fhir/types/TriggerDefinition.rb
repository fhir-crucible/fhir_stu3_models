module FHIR
  module STU3
    class TriggerDefinition < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'eventTimingReference' => {'type'=>'Reference', 'path'=>'TriggerDefinition.eventTiming[x]', 'min'=>0, 'max'=>1},
      ...
      attr_accessor :eventTimingReference # 0-1 Reference()
