module FHIR
  module STU3
    class ModuleMetadata < FHIR::STU3::Model
      ...
      class Contributor < FHIR::STU3::Model
        include FHIR::STU3::Hashable
        include FHIR::STU3::Json
        include FHIR::STU3::Xml
      ...
      class RelatedResource < FHIR::STU3::Model
        include FHIR::STU3::Hashable
        include FHIR::STU3::Json
        include FHIR::STU3::Xml
        ...
        METADATA = {
          ...
          'resource' => {'type'=>'Reference', 'path'=>'RelatedResource.resource', 'min'=>0, 'max'=>1}
        }
