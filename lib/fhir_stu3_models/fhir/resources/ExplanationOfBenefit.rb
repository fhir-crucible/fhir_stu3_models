  ...
  module STU3
    class ExplanationOfBenefit < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'claimReference' => {'type'=>'Reference', 'path'=>'ExplanationOfBenefit.claim[x]', 'min'=>0, 'max'=>1},
        'claimResponseIdentifier' => {'type'=>'Identifier', 'path'=>'ExplanationOfBenefit.claimResponse[x]', 'min'=>0, 'max'=>1},
        'claimResponseReference' => {'type'=>'Reference', 'path'=>'ExplanationOfBenefit.claimResponse[x]', 'min'=>0, 'max'=>1},
        ...
        'providerReference' => {'type'=>'Reference', 'path'=>'ExplanationOfBenefit.provider[x]', 'min'=>0, 'max'=>1},
        'organizationIdentifier' => {'type'=>'Identifier', 'path'=>'ExplanationOfBenefit.organization[x]', 'min'=>0, 'max'=>1},
        'organizationReference' => {'type'=>'Reference', 'path'=>'ExplanationOfBenefit.organization[x]', 'min'=>0, 'max'=>1},
        'facilityIdentifier' => {'type'=>'Identifier', 'path'=>'ExplanationOfBenefit.facility[x]', 'min'=>0, 'max'=>1},
        'facilityReference' => {'type'=>'Reference', 'path'=>'ExplanationOfBenefit.facility[x]', 'min'=>0, 'max'=>1},
        ...
        'prescriptionReference' => {'type'=>'Reference', 'path'=>'ExplanationOfBenefit.prescription[x]', 'min'=>0, 'max'=>1},
        'originalPrescriptionIdentifier' => {'type'=>'Identifier', 'path'=>'ExplanationOfBenefit.originalPrescription[x]', 'min'=>0, 'max'=>1},
        'originalPrescriptionReference' => {'type'=>'Reference', 'path'=>'ExplanationOfBenefit.originalPrescription[x]', 'min'=>0, 'max'=>1},
        ...
        'referralReference' => {'type'=>'Reference', 'path'=>'ExplanationOfBenefit.referral[x]', 'min'=>0, 'max'=>1},
        ...
        'patientReference' => {'type'=>'Reference', 'path'=>'ExplanationOfBenefit.patient[x]', 'min'=>1, 'max'=>1},
        ...
        'accidentLocationReference' => {'type'=>'Reference', 'path'=>'ExplanationOfBenefit.accidentLocation[x]', 'min'=>0, 'max'=>1},
      ...
      class Item < FHIR::STU3::Model
        ...
        class Detail < FHIR::STU3::Model
          ...
          class Subadjudication < FHIR::STU3::Model
            include FHIR::STU3::Hashable
            include FHIR::STU3::Json
            include FHIR::STU3::Xml
      ...
      attr_accessor :claimResponseReference         # 0-1 Reference()
