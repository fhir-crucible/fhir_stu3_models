  ...
  module STU3
    class ConceptMap < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'useContext' => {'valid_codes'=>{'urn:iso:std:iso:3166'=>[], 'http://unstats.un.org/unsd/methods/m49/m49.htm'=>[]}, 'type'=>'CodeableConcept', 'path'=>'ConceptMap.useContext', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/use-context'}},
      ...
      class Element < FHIR::STU3::Model
        ...
        class Target < FHIR::STU3::Model
          ...
          METADATA = {
            ...
            'product' => {'type'=>'DependsOn', 'path'=>'Target.product', 'min'=>0, 'max'=>Float::INFINITY}
          }
          ...
          attr_accessor :product           # 0-* [ DependsOn ]
        end
