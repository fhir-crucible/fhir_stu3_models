  ...
  module STU3
    class StructureMap < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'useContext' => {'valid_codes'=>{'urn:iso:std:iso:3166'=>[], 'http://unstats.un.org/unsd/methods/m49/m49.htm'=>[]}, 'type'=>'CodeableConcept', 'path'=>'StructureMap.useContext', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/use-context'}},
      ...
      class Group < FHIR::STU3::Model
        ...
        class Rule < FHIR::STU3::Model
          ...
          METADATA = {
            ...
            'rule' => {'type'=>'Rule', 'path'=>'Rule.rule', 'min'=>0, 'max'=>Float::INFINITY},
