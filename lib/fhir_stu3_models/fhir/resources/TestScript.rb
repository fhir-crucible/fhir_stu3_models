module FHIR
  module STU3
    class TestScript < FHIR::STU3::Model
      ...
      class Metadata < FHIR::STU3::Model
        include FHIR::STU3::Hashable
        include FHIR::STU3::Json
        include FHIR::STU3::Xml
        ...
        class Capability < FHIR::STU3::Model
          include FHIR::STU3::Hashable
          include FHIR::STU3::Json
          include FHIR::STU3::Xml
      ...
      class Setup < FHIR::STU3::Model
        ...
        class Action < FHIR::STU3::Model
          ...
          class Operation < FHIR::STU3::Model
            ...
            class RequestHeader < FHIR::STU3::Model
              include FHIR::STU3::Hashable
              include FHIR::STU3::Json
              include FHIR::STU3::Xml
      ...
      class Teardown < FHIR::STU3::Model
        include FHIR::STU3::Hashable
        include FHIR::STU3::Json
        include FHIR::STU3::Xml
