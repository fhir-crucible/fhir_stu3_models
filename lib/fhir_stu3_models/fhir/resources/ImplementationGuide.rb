  ...
  module STU3
    class ImplementationGuide < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'useContext' => {'valid_codes'=>{'urn:iso:std:iso:3166'=>[], 'http://unstats.un.org/unsd/methods/m49/m49.htm'=>[]}, 'type'=>'CodeableConcept', 'path'=>'ImplementationGuide.useContext', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/use-context'}},
      ...
      class Page < FHIR::STU3::Model
        ...
        METADATA = {
          ...
          'page' => {'type'=>'Page', 'path'=>'Page.page', 'min'=>0, 'max'=>Float::INFINITY}
        }
