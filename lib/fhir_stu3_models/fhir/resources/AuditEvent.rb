module FHIR
  module STU3
    class AuditEvent < FHIR::STU3::Model
      ...
      class Agent < FHIR::STU3::Model
        ...
        METADATA = {
          ...
          'reference' => {'type'=>'Reference', 'path'=>'Agent.reference', 'min'=>0, 'max'=>1},
          ...
          'location' => {'type'=>'Reference', 'path'=>'Agent.location', 'min'=>0, 'max'=>1},
      ...
      class Entity < FHIR::STU3::Model
        ...
        METADATA = {
          ...
          'reference' => {'type'=>'Reference', 'path'=>'Entity.reference', 'min'=>0, 'max'=>1},
