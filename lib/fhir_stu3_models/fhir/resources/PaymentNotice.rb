module FHIR
  module STU3
    class PaymentNotice < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'targetReference' => {'type'=>'Reference', 'path'=>'PaymentNotice.target[x]', 'min'=>0, 'max'=>1},
        'providerIdentifier' => {'type'=>'Identifier', 'path'=>'PaymentNotice.provider[x]', 'min'=>0, 'max'=>1},
        'providerReference' => {'type'=>'Reference', 'path'=>'PaymentNotice.provider[x]', 'min'=>0, 'max'=>1},
        'organizationIdentifier' => {'type'=>'Identifier', 'path'=>'PaymentNotice.organization[x]', 'min'=>0, 'max'=>1},
        'organizationReference' => {'type'=>'Reference', 'path'=>'PaymentNotice.organization[x]', 'min'=>0, 'max'=>1},
        'requestIdentifier' => {'type'=>'Identifier', 'path'=>'PaymentNotice.request[x]', 'min'=>0, 'max'=>1},
        'requestReference' => {'type'=>'Reference', 'path'=>'PaymentNotice.request[x]', 'min'=>0, 'max'=>1},
        'responseIdentifier' => {'type'=>'Identifier', 'path'=>'PaymentNotice.response[x]', 'min'=>0, 'max'=>1},
        'responseReference' => {'type'=>'Reference', 'path'=>'PaymentNotice.response[x]', 'min'=>0, 'max'=>1},
