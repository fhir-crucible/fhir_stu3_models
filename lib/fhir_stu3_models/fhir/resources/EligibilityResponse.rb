  ...
  module STU3
    class EligibilityResponse < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'requestReference' => {'type'=>'Reference', 'path'=>'EligibilityResponse.request[x]', 'min'=>0, 'max'=>1},
        ...
        'organizationReference' => {'type'=>'Reference', 'path'=>'EligibilityResponse.organization[x]', 'min'=>0, 'max'=>1},
        'requestProviderIdentifier' => {'type'=>'Identifier', 'path'=>'EligibilityResponse.requestProvider[x]', 'min'=>0, 'max'=>1},
        'requestProviderReference' => {'type'=>'Reference', 'path'=>'EligibilityResponse.requestProvider[x]', 'min'=>0, 'max'=>1},
        'requestOrganizationIdentifier' => {'type'=>'Identifier', 'path'=>'EligibilityResponse.requestOrganization[x]', 'min'=>0, 'max'=>1},
        'requestOrganizationReference' => {'type'=>'Reference', 'path'=>'EligibilityResponse.requestOrganization[x]', 'min'=>0, 'max'=>1},
        'inforce' => {'type'=>'boolean', 'path'=>'EligibilityResponse.inforce', 'min'=>0, 'max'=>1},
        'contract' => {'type'=>'Reference', 'path'=>'EligibilityResponse.contract', 'min'=>0, 'max'=>1},
