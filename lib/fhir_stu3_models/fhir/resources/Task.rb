  ...
  module STU3
    class Task < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'subject' => {'type'=>'Reference', 'path'=>'Task.subject', 'min'=>0, 'max'=>1},
        ...
        'creator' => {'type'=>'Reference', 'path'=>'Task.creator', 'min'=>1, 'max'=>1},
        'owner' => {'type'=>'Reference', 'path'=>'Task.owner', 'min'=>0, 'max'=>1},
        'parent' => {'type'=>'Reference', 'path'=>'Task.parent', 'min'=>0, 'max'=>1},
      ...
      attr_accessor :creator           # 1-1 Reference()
