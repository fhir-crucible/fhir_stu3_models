  ...
  class Consent < FHIR::Model
    ...
    class Except < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'valid_codes'=>{'http://hl7.org/fhir/consent-except-type'=>['deny', 'permit']}, 'type'=>'code', 'path'=>'Except.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/consent-except-type'}},
        ...
        'action' => {'valid_codes'=>{'http://hl7.org/fhir/consentaction'=>['collect', 'access', 'use', 'disclose', 'correct']}, 'type'=>'CodeableConcept', 'path'=>'Except.action', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/consent-action'}},
