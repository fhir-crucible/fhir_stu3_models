  ...
  module STU3
    class OperationDefinition < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'useContext' => {'valid_codes'=>{'urn:iso:std:iso:3166'=>[], 'http://unstats.un.org/unsd/methods/m49/m49.htm'=>[]}, 'type'=>'CodeableConcept', 'path'=>'OperationDefinition.useContext', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/use-context'}},
      ...
      class Parameter < FHIR::STU3::Model
        ...
        METADATA = {
          ...
          'part' => {'type'=>'Parameter', 'path'=>'Parameter.part', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        attr_accessor :part              # 0-* [ Parameter ]
      end
