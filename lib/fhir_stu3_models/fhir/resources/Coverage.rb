  ...
  module STU3
    class Coverage < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'issuerReference' => {'type'=>'Reference', 'path'=>'Coverage.issuer[x]', 'min'=>1, 'max'=>1},
        ...
        'planholderReference' => {'type'=>'Reference', 'path'=>'Coverage.planholder[x]', 'min'=>1, 'max'=>1},
        'beneficiaryIdentifier' => {'type'=>'Identifier', 'path'=>'Coverage.beneficiary[x]', 'min'=>1, 'max'=>1},
        'beneficiaryReference' => {'type'=>'Reference', 'path'=>'Coverage.beneficiary[x]', 'min'=>1, 'max'=>1},
