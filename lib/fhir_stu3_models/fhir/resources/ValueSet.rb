  ...
  module STU3
    class ValueSet < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'useContext' => {'valid_codes'=>{'urn:iso:std:iso:3166'=>[], 'http://unstats.un.org/unsd/methods/m49/m49.htm'=>[]}, 'type'=>'CodeableConcept', 'path'=>'ValueSet.useContext', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/use-context'}},
      ...
      class Compose < FHIR::STU3::Model
        ...
        METADATA = {
          ...
          'exclude' => {'type'=>'Include', 'path'=>'Compose.exclude', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        attr_accessor :exclude           # 0-* [ Include ]
      end
      ...
      class Expansion < FHIR::STU3::Model
        ...
        class Contains < FHIR::STU3::Model
          ...
          METADATA = {
            ...
            'contains' => {'type'=>'Contains', 'path'=>'Contains.contains', 'min'=>0, 'max'=>Float::INFINITY}
          }
          ...
          attr_accessor :display           # 0-1 string
          attr_accessor :contains          # 0-* [ Contains ]
        end
