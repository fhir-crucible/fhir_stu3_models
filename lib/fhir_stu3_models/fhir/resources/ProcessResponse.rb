  ...
  module STU3
    class ProcessResponse < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'requestReference' => {'type'=>'Reference', 'path'=>'ProcessResponse.request[x]', 'min'=>0, 'max'=>1},
        ...
        'organizationReference' => {'type'=>'Reference', 'path'=>'ProcessResponse.organization[x]', 'min'=>0, 'max'=>1},
        'requestProviderIdentifier' => {'type'=>'Identifier', 'path'=>'ProcessResponse.requestProvider[x]', 'min'=>0, 'max'=>1},
        'requestProviderReference' => {'type'=>'Reference', 'path'=>'ProcessResponse.requestProvider[x]', 'min'=>0, 'max'=>1},
        'requestOrganizationIdentifier' => {'type'=>'Identifier', 'path'=>'ProcessResponse.requestOrganization[x]', 'min'=>0, 'max'=>1},
        'requestOrganizationReference' => {'type'=>'Reference', 'path'=>'ProcessResponse.requestOrganization[x]', 'min'=>0, 'max'=>1},
