module FHIR
  module STU3
    class ImagingObjectSelection < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'patient' => {'type'=>'Reference', 'path'=>'ImagingObjectSelection.patient', 'min'=>1, 'max'=>1},
        'authoringTime' => {'type'=>'dateTime', 'path'=>'ImagingObjectSelection.authoringTime', 'min'=>0, 'max'=>1},
        'author' => {'type'=>'Reference', 'path'=>'ImagingObjectSelection.author', 'min'=>0, 'max'=>1},
