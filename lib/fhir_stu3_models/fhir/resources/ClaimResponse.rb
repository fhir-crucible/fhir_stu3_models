  ...
  module STU3
    class ClaimResponse < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'requestReference' => {'type'=>'Reference', 'path'=>'ClaimResponse.request[x]', 'min'=>0, 'max'=>1},
        ...
        'organizationReference' => {'type'=>'Reference', 'path'=>'ClaimResponse.organization[x]', 'min'=>0, 'max'=>1},
        'requestProviderIdentifier' => {'type'=>'Identifier', 'path'=>'ClaimResponse.requestProvider[x]', 'min'=>0, 'max'=>1},
        'requestProviderReference' => {'type'=>'Reference', 'path'=>'ClaimResponse.requestProvider[x]', 'min'=>0, 'max'=>1},
        'requestOrganizationIdentifier' => {'type'=>'Identifier', 'path'=>'ClaimResponse.requestOrganization[x]', 'min'=>0, 'max'=>1},
        'requestOrganizationReference' => {'type'=>'Reference', 'path'=>'ClaimResponse.requestOrganization[x]', 'min'=>0, 'max'=>1},
