  ...
  module STU3
    class EligibilityRequest < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'targetReference' => {'type'=>'Reference', 'path'=>'EligibilityRequest.target[x]', 'min'=>0, 'max'=>1},
        'providerIdentifier' => {'type'=>'Identifier', 'path'=>'EligibilityRequest.provider[x]', 'min'=>0, 'max'=>1},
        'providerReference' => {'type'=>'Reference', 'path'=>'EligibilityRequest.provider[x]', 'min'=>0, 'max'=>1},
        'organizationIdentifier' => {'type'=>'Identifier', 'path'=>'EligibilityRequest.organization[x]', 'min'=>0, 'max'=>1},
        'organizationReference' => {'type'=>'Reference', 'path'=>'EligibilityRequest.organization[x]', 'min'=>0, 'max'=>1},
        ...
        'entererReference' => {'type'=>'Reference', 'path'=>'EligibilityRequest.enterer[x]', 'min'=>0, 'max'=>1},
        'facilityIdentifier' => {'type'=>'Identifier', 'path'=>'EligibilityRequest.facility[x]', 'min'=>0, 'max'=>1},
        'facilityReference' => {'type'=>'Reference', 'path'=>'EligibilityRequest.facility[x]', 'min'=>0, 'max'=>1},
        'patientIdentifier' => {'type'=>'Identifier', 'path'=>'EligibilityRequest.patient[x]', 'min'=>0, 'max'=>1},
        'patientReference' => {'type'=>'Reference', 'path'=>'EligibilityRequest.patient[x]', 'min'=>0, 'max'=>1},
        'coverageIdentifier' => {'type'=>'Identifier', 'path'=>'EligibilityRequest.coverage[x]', 'min'=>0, 'max'=>1},
        'coverageReference' => {'type'=>'Reference', 'path'=>'EligibilityRequest.coverage[x]', 'min'=>0, 'max'=>1},
      ...
      attr_accessor :patientReference       # 0-1 Reference()
      attr_accessor :coverageIdentifier     # 0-1 Identifier
      attr_accessor :coverageReference      # 0-1 Reference()
