module FHIR
  module STU3
    class ImagingExcerpt < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'patient' => {'type'=>'Reference', 'path'=>'ImagingExcerpt.patient', 'min'=>1, 'max'=>1},
        'authoringTime' => {'type'=>'dateTime', 'path'=>'ImagingExcerpt.authoringTime', 'min'=>0, 'max'=>1},
        'author' => {'type'=>'Reference', 'path'=>'ImagingExcerpt.author', 'min'=>0, 'max'=>1},
      ...
      class Study < FHIR::STU3::Model
        ...
        METADATA = {
          ...
          'imagingStudy' => {'type'=>'Reference', 'path'=>'Study.imagingStudy', 'min'=>0, 'max'=>1},
        ...
        class Viewable < FHIR::STU3::Model
          include FHIR::STU3::Hashable
          include FHIR::STU3::Json
          include FHIR::STU3::Xml
        ...
        class Series < FHIR::STU3::Model
          ...
          class Instance < FHIR::STU3::Model
            include FHIR::STU3::Hashable
            include FHIR::STU3::Json
            include FHIR::STU3::Xml
        ...
        attr_accessor :modifierExtension # 0-* [ Extension ]
        attr_accessor :uid               # 1-1 oid
        attr_accessor :imagingStudy      # 0-1 Reference()
