  ...
  module STU3
    class Media < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'subtype' => {'valid_codes'=>{'http://snomed.info/sct'=>[], 'http://hl7.org/fhir/media-subtype'=>['diagram', 'fax', 'scan', 'retina', 'fingerprint', 'iris', 'palm', 'face']}, 'type'=>'CodeableConcept', 'path'=>'Media.subtype', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/digital-media-subtype'}},
