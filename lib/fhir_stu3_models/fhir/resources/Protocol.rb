module FHIR
  module STU3
    class Protocol < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'subject' => {'type'=>'Reference', 'path'=>'Protocol.subject', 'min'=>0, 'max'=>1},
        'group' => {'type'=>'Reference', 'path'=>'Protocol.group', 'min'=>0, 'max'=>1},
        'purpose' => {'type'=>'string', 'path'=>'Protocol.purpose', 'min'=>1, 'max'=>1},
        'author' => {'type'=>'Reference', 'path'=>'Protocol.author', 'min'=>0, 'max'=>1},
        'step' => {'type'=>'Protocol::Step', 'path'=>'Protocol.step', 'min'=>0, 'max'=>Float::INFINITY}
      }

      class Step < FHIR::STU3::Model
        include FHIR::STU3::Hashable
        include FHIR::STU3::Json
        include FHIR::STU3::Xml
        ...
        METADATA = {
          ...
          'exit' => {'type'=>'Precondition', 'path'=>'Step.exit', 'min'=>0, 'max'=>1},
        ...
        class Precondition < FHIR::STU3::Model
          include FHIR::STU3::Hashable
          include FHIR::STU3::Json
          include FHIR::STU3::Xml
          ...
          METADATA = {
            ...
            'intersection' => {'type'=>'Precondition', 'path'=>'Precondition.intersection', 'min'=>0, 'max'=>Float::INFINITY},
            'union' => {'type'=>'Precondition', 'path'=>'Precondition.union', 'min'=>0, 'max'=>Float::INFINITY},
            'exclude' => {'type'=>'Precondition', 'path'=>'Precondition.exclude', 'min'=>0, 'max'=>Float::INFINITY}
          }
          ...
          attr_accessor :intersection      # 0-* [ Precondition ]
          attr_accessor :union             # 0-* [ Precondition ]
          attr_accessor :exclude           # 0-* [ Precondition ]
        end

        class Activity < FHIR::STU3::Model
          include FHIR::STU3::Hashable
          include FHIR::STU3::Json
          include FHIR::STU3::Xml
          ...
          class Component < FHIR::STU3::Model
            include FHIR::STU3::Hashable
            include FHIR::STU3::Json
            include FHIR::STU3::Xml
          ...
          class Detail < FHIR::STU3::Model
            ...
            METADATA = {
              ...
              'product' => {'type'=>'Reference', 'path'=>'Detail.product', 'min'=>0, 'max'=>1},
            ...
            attr_accessor :product               # 0-1 Reference()
        ...
        class Next < FHIR::STU3::Model
          ...
          METADATA = {
            ...
            'condition' => {'type'=>'Precondition', 'path'=>'Next.condition', 'min'=>0, 'max'=>1}
          }
          ...
          attr_accessor :condition         # 0-1 Precondition
        end
        ...
        attr_accessor :exit              # 0-1 Precondition
      ...
      attr_accessor :group             # 0-1 Reference()
