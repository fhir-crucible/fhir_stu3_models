  ...
  module STU3
    class PaymentReconciliation < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'requestReference' => {'type'=>'Reference', 'path'=>'PaymentReconciliation.request[x]', 'min'=>0, 'max'=>1},
        ...
        'organizationReference' => {'type'=>'Reference', 'path'=>'PaymentReconciliation.organization[x]', 'min'=>0, 'max'=>1},
        'requestProviderIdentifier' => {'type'=>'Identifier', 'path'=>'PaymentReconciliation.requestProvider[x]', 'min'=>0, 'max'=>1},
        'requestProviderReference' => {'type'=>'Reference', 'path'=>'PaymentReconciliation.requestProvider[x]', 'min'=>0, 'max'=>1},
        'requestOrganizationIdentifier' => {'type'=>'Identifier', 'path'=>'PaymentReconciliation.requestOrganization[x]', 'min'=>0, 'max'=>1},
        'requestOrganizationReference' => {'type'=>'Reference', 'path'=>'PaymentReconciliation.requestOrganization[x]', 'min'=>0, 'max'=>1},
      ...
      class Detail < FHIR::STU3::Model
        ...
        METADATA = {
          ...
          'requestReference' => {'type'=>'Reference', 'path'=>'Detail.request[x]', 'min'=>0, 'max'=>1},
          'responceIdentifier' => {'type'=>'Identifier', 'path'=>'Detail.responce[x]', 'min'=>0, 'max'=>1},
          'responceReference' => {'type'=>'Reference', 'path'=>'Detail.responce[x]', 'min'=>0, 'max'=>1},
          'submitterIdentifier' => {'type'=>'Identifier', 'path'=>'Detail.submitter[x]', 'min'=>0, 'max'=>1},
          'submitterReference' => {'type'=>'Reference', 'path'=>'Detail.submitter[x]', 'min'=>0, 'max'=>1},
          'payeeIdentifier' => {'type'=>'Identifier', 'path'=>'Detail.payee[x]', 'min'=>0, 'max'=>1},
          'payeeReference' => {'type'=>'Reference', 'path'=>'Detail.payee[x]', 'min'=>0, 'max'=>1},
        ...
        attr_accessor :requestReference    # 0-1 Reference()
        attr_accessor :responceIdentifier  # 0-1 Identifier
        attr_accessor :responceReference   # 0-1 Reference()
        attr_accessor :submitterIdentifier # 0-1 Identifier
        attr_accessor :submitterReference  # 0-1 Reference()
        attr_accessor :payeeIdentifier     # 0-1 Identifier
        attr_accessor :payeeReference      # 0-1 Reference()
      ...
      attr_accessor :requestProviderReference      # 0-1 Reference()
      attr_accessor :requestOrganizationIdentifier # 0-1 Identifier
      attr_accessor :requestOrganizationReference  # 0-1 Reference()
