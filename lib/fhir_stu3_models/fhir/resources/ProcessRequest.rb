module FHIR
  module STU3
    class ProcessRequest < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'targetReference' => {'type'=>'Reference', 'path'=>'ProcessRequest.target[x]', 'min'=>0, 'max'=>1},
        'providerIdentifier' => {'type'=>'Identifier', 'path'=>'ProcessRequest.provider[x]', 'min'=>0, 'max'=>1},
        'providerReference' => {'type'=>'Reference', 'path'=>'ProcessRequest.provider[x]', 'min'=>0, 'max'=>1},
        'organizationIdentifier' => {'type'=>'Identifier', 'path'=>'ProcessRequest.organization[x]', 'min'=>0, 'max'=>1},
        'organizationReference' => {'type'=>'Reference', 'path'=>'ProcessRequest.organization[x]', 'min'=>0, 'max'=>1},
        'requestIdentifier' => {'type'=>'Identifier', 'path'=>'ProcessRequest.request[x]', 'min'=>0, 'max'=>1},
        'requestReference' => {'type'=>'Reference', 'path'=>'ProcessRequest.request[x]', 'min'=>0, 'max'=>1},
        'responseIdentifier' => {'type'=>'Identifier', 'path'=>'ProcessRequest.response[x]', 'min'=>0, 'max'=>1},
        'responseReference' => {'type'=>'Reference', 'path'=>'ProcessRequest.response[x]', 'min'=>0, 'max'=>1},
      ...
      attr_accessor :responseReference      # 0-1 Reference()
