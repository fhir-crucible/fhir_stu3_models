  ...
  module STU3
    class CodeSystem < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'useContext' => {'valid_codes'=>{'urn:iso:std:iso:3166'=>[], 'http://unstats.un.org/unsd/methods/m49/m49.htm'=>[]}, 'type'=>'CodeableConcept', 'path'=>'CodeSystem.useContext', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/use-context'}},
      ...
      class Concept < FHIR::STU3::Model
        ...
        METADATA = {
          ...
          'concept' => {'type'=>'Concept', 'path'=>'Concept.concept', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        attr_accessor :concept           # 0-* [ Concept ]
      end
