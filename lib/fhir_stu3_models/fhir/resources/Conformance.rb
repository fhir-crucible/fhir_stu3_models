module FHIR
  module STU3
    class Conformance < FHIR::STU3::Model
      ...
      METADATA = {
        ...
        'useContext' => {'valid_codes'=>{'urn:iso:std:iso:3166'=>[], 'http://unstats.un.org/unsd/methods/m49/m49.htm'=>[]}, 'type'=>'CodeableConcept', 'path'=>'Conformance.useContext', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/use-context'}},
      ...
      class Rest < FHIR::STU3::Model
        ...
        METADATA = {
          ...
          'searchParam' => {'type'=>'SearchParam', 'path'=>'Rest.searchParam', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        attr_accessor :searchParam       # 0-* [ SearchParam ]
