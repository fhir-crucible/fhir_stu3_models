module FHIR
  class Observation < FHIR::Model
    ...
    SEARCH_PARAMS = ["category", "code", "data-absent-reason", "date", "device", "encounter", "identifier", "method", "patient", "performer", "related-target", "related-type", "specimen", "status", "subject", "value-concept", "value-date", "value-quantity", "value-string"]
    METADATA = {
      ...
      'language' => {'type'=>'code', 'path'=>'Observation.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
      ...
      'category' => {'valid_codes'=>{'http://hl7.org/fhir/observation-category'=>['social-history', 'vital-signs', 'imaging', 'laboratory', 'procedure', 'survey', 'exam', 'therapy', 'social-history', 'vital-signs', 'imaging', 'laboratory', 'procedure', 'survey', 'exam', 'therapy']}, 'type'=>'CodeableConcept', 'path'=>'Observation.category', 'min'=>0, 'max'=>Float::INFINITY, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/observation-category'}},
      ...
      'performer' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/Organization', 'http://hl7.org/fhir/StructureDefinition/Patient', 'http://hl7.org/fhir/StructureDefinition/RelatedPerson'], 'type'=>'Reference', 'path'=>'Observation.performer', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      'dataAbsentReason' => {'valid_codes'=>{'http://hl7.org/fhir/data-absent-reason'=>['unknown', 'asked', 'temp', 'not-asked', 'masked', 'unsupported', 'astext', 'error', 'NaN', 'not-performed', 'unknown', 'asked', 'temp', 'not-asked', 'masked', 'unsupported', 'astext', 'error', 'not-performed']}, 'type'=>'CodeableConcept', 'path'=>'Observation.dataAbsentReason', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/observation-valueabsentreason'}},
      'interpretation' => {'valid_codes'=>{'http://hl7.org/fhir/v2/0078'=>['<', '>', 'A', 'AA', 'B', 'D', 'DET', 'H', 'HH', 'HU', 'I', 'IE', 'IND', 'L', 'LL', 'LU', 'MS', 'N', 'ND', 'NEG', 'NR', 'NS', 'POS', 'R', 'RR', 'S', 'SDD', 'SYN-R', 'SYN-S', 'U', 'VS', 'W', 'WR']}, 'type'=>'CodeableConcept', 'path'=>'Observation.interpretation', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/observation-interpretation'}},
      'comment' => {'type'=>'string', 'path'=>'Observation.comment', 'min'=>0, 'max'=>1},
    ...
    class Component < FHIR::Model
      ...
      METADATA = {
        ...
        'dataAbsentReason' => {'valid_codes'=>{'http://hl7.org/fhir/data-absent-reason'=>['unknown', 'asked', 'temp', 'not-asked', 'masked', 'unsupported', 'astext', 'error', 'NaN', 'not-performed', 'unknown', 'asked', 'temp', 'not-asked', 'masked', 'unsupported', 'astext', 'error', 'not-performed']}, 'type'=>'CodeableConcept', 'path'=>'Component.dataAbsentReason', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/observation-valueabsentreason'}},
        'interpretation' => {'valid_codes'=>{'http://hl7.org/fhir/v2/0078'=>['<', '>', 'A', 'AA', 'B', 'D', 'DET', 'H', 'HH', 'HU', 'I', 'IE', 'IND', 'L', 'LL', 'LU', 'MS', 'N', 'ND', 'NEG', 'NR', 'NS', 'POS', 'R', 'RR', 'S', 'SDD', 'SYN-R', 'SYN-S', 'U', 'VS', 'W', 'WR']}, 'type'=>'CodeableConcept', 'path'=>'Component.interpretation', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/observation-interpretation'}},
