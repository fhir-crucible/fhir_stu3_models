module FHIR
  class Medication < FHIR::Model
    ...
    METADATA = {
      ...
      'status' => {'valid_codes'=>{'http://hl7.org/fhir/medication-status'=>['active', 'inactive', 'entered-in-error', 'active', 'inactive', 'entered-in-error']}, 'type'=>'code', 'path'=>'Medication.status', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/medication-status'}},
    ...
    class Package < FHIR::Model
      ...
      METADATA = {
        ...
        'container' => {'valid_codes'=>{'http://hl7.org/fhir/medication-package-form'=>['ampoule', 'bottle', 'box', 'cartridge', 'container', 'tube', 'unitdose', 'vial', 'ampoule', 'bottle', 'box', 'cartridge', 'container', 'tube', 'unitdose', 'vial']}, 'type'=>'CodeableConcept', 'path'=>'Package.container', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/medication-package-form'}},
