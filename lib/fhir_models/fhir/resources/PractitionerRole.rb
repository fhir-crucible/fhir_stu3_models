module FHIR
  class PractitionerRole < FHIR::Model
    ...
    METADATA = {
      ...
      'practitioner' => {'type'=>'Reference', 'path'=>'PractitionerRole.practitioner', 'min'=>0, 'max'=>1},
      'organization' => {'type'=>'Reference', 'path'=>'PractitionerRole.organization', 'min'=>0, 'max'=>1},
      ...
      'endpoint' => {'type'=>'Reference', 'path'=>'PractitionerRole.endpoint', 'min'=>0, 'max'=>Float::INFINITY}
    }
