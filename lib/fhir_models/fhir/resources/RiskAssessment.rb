module FHIR
  class RiskAssessment < FHIR::Model
    ...
    METADATA = {
      ...
      'basedOn' => {'type'=>'Reference', 'path'=>'RiskAssessment.basedOn', 'min'=>0, 'max'=>1},
      'parent' => {'type'=>'Reference', 'path'=>'RiskAssessment.parent', 'min'=>0, 'max'=>1},
      ...
      'context' => {'type'=>'Reference', 'path'=>'RiskAssessment.context', 'min'=>0, 'max'=>1},
      ...
      'reasonReference' => {'type'=>'Reference', 'path'=>'RiskAssessment.reason[x]', 'min'=>0, 'max'=>1},
    ...
    attr_accessor :basedOn               # 0-1 Reference()
