module FHIR
  class Contract < FHIR::Model
    ...
    METADATA = {
      ...
      'contentDerivative' => {'valid_codes'=>{'http://hl7.org/fhir/contract-content-derivative'=>['registration', 'retrieval', 'statement', 'shareable', 'registration', 'retrieval', 'statement', 'shareable']}, 'type'=>'CodeableConcept', 'path'=>'Contract.contentDerivative', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/contract-content-derivative'}},
    ...
    class Term < FHIR::Model
      ...
      METADATA = {
        ...
        'type' => {'valid_codes'=>{'http://hl7.org/fhir/contracttermtypecodes'=>['statutory', 'subject-to', 'statutory', 'subject-to']}, 'type'=>'CodeableConcept', 'path'=>'Term.type', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/contract-term-type'}},
        'subType' => {'valid_codes'=>{'http://hl7.org/fhir/contracttermsubtypecodes'=>['condition', 'warranty', 'innominate', 'condition', 'warranty', 'innominate']}, 'type'=>'CodeableConcept', 'path'=>'Term.subType', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/contract-term-subtype'}},
