module FHIR
  class MedicationDispense < FHIR::Model
    ...
    METADATA = {
      ...
      'status' => {'valid_codes'=>{'http://hl7.org/fhir/medication-dispense-status'=>['preparation', 'in-progress', 'on-hold', 'completed', 'entered-in-error', 'stopped', 'preparation', 'in-progress', 'on-hold', 'completed', 'entered-in-error', 'stopped']}, 'type'=>'code', 'path'=>'MedicationDispense.status', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/medication-dispense-status'}},
      'category' => {'valid_codes'=>{'http://hl7.org/fhir/medication-dispense-category'=>['inpatient', 'outpatient', 'community', 'inpatient', 'outpatient', 'community']}, 'type'=>'CodeableConcept', 'path'=>'MedicationDispense.category', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/medication-dispense-category'}},
