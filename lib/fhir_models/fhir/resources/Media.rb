module FHIR
  class Media < FHIR::Model
    ...
    METADATA = {
      ...
      'language' => {'type'=>'code', 'path'=>'Media.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/languages'}},
      ...
      'subtype' => {'valid_codes'=>{'http://nema.org/dicom/dicm'=>['AR', 'BMD', 'BDUS', 'EPS', 'CR', 'CT', 'DX', 'ECG', 'ES', 'XC', 'GM', 'HD', 'IO', 'IVOCT', 'IVUS', 'KER', 'LEN', 'MR', 'MG', 'NM', 'OAM', 'OCT', 'OPM', 'OP', 'OPR', 'OPT', 'OPV', 'OSS', 'PX', 'PT', 'RF', 'RG', 'SM', 'SRF', 'US', 'VA', 'XA'], 'http://hl7.org/fhir/media-subtype'=>['diagram', 'fax', 'scan', 'retina', 'fingerprint', 'iris', 'palm', 'face', 'diagram', 'fax', 'scan', 'retina', 'fingerprint', 'iris', 'palm', 'face'], 'http://snomed.info/sct'=>[]}, 'type'=>'CodeableConcept', 'path'=>'Media.subtype', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/digital-media-subtype'}},
