  ...
  class ElementDefinition < FHIR::Model
    ...
    class Slicing < FHIR::Model
      ...
      class Discriminator < FHIR::Model
        ...
        METADATA = {
          ...
          'type' => {'valid_codes'=>{'http://hl7.org/fhir/discriminator-type'=>['value', 'exists', 'pattern', 'type', 'profile', 'value', 'exists', 'pattern', 'type', 'profile']}, 'type'=>'code', 'path'=>'Discriminator.type', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/discriminator-type'}},
    ...
    class Constraint < FHIR::Model
      ...
      METADATA = {
        ...
        'expression' => {'type'=>'string', 'path'=>'Constraint.expression', 'min'=>1, 'max'=>1},
        'xpath' => {'type'=>'string', 'path'=>'Constraint.xpath', 'min'=>0, 'max'=>1},
        'source' => {'type'=>'uri', 'path'=>'Constraint.source', 'min'=>0, 'max'=>1}
      }
