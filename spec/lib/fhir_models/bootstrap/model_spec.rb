RSpec.describe 'FHIR::STU3::Model' do
  describe '#hash' do
    it 'should be the same for two identical fhir models' do
      ...
      patient1 = FHIR::STU3::Patient.new(attributes)
      patient2 = FHIR::STU3::Patient.new(attributes)
    ...
    it 'should be different for two models that do not have the same attributes' do
      ...
      patient1 = FHIR::STU3::Patient.new(attributes1)
      patient2 = FHIR::STU3::Patient.new(attributes2)
  ...
  describe '#respond_to?' do
    it 'returns true for :value on choice elements' do
      extension = FHIR::STU3::Extension.new(valueInteger: 5)
    ...
    it 'returns false for :value on nonchoice elements' do
      range = FHIR::STU3::Range.new(low: {value: 18})
